...
docker.visualization<-function(input.file,output.PlotFolder,feature,title=NULL,labels.x=NULL,labels.y=NULL)
{
  ...
  params <- paste( "--cidfile", paste0(data.folder, "/dockerID"),
                   ...
                   "qbioturin/connector Rscript /Scripts/Visualization.R",feature,labels.x,labels.y,title)
