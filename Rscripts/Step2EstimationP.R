...
docker.estimation.p<-function(input.file,output.folder,pmin=2,pmax=10)
{
  ...
  params <- paste( "--cidfile", paste0(data.folder, "/dockerID"),
                   ...
                   "qbioturin/connector Rscript /Scripts/Estimation_p.R",pmin,pmax)
...
docker.estimation.p(input.file=input.file,output.folder=output.folder,pmin=pMin,pmax=pMax)